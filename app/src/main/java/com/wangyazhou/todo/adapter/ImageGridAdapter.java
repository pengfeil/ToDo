...
public class ImageGridAdapter extends BaseAdapter {
    ...
    private Point mPoint = new Point(240, 240); // Record size of images
	...
	if (image.getPath() == null) {
	    ...
	    if (holder.image.getMeasuredHeight() > 0
		    || holder.image.getMeasuredWidth() > 0) {
		Bitmap bitmap = nativeImageLoader.loadNativeImage(
			image.getPath(), mPoint,
		...
		holder.picker.setImageResource(R.drawable.selectimageselected);
	    }
	}
	return convertView;
    }
